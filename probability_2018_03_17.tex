...
\begin{theorem}[Закон больших чисел в форме Чебышёва]
	...
	\begin{proof}
		...
		$$\P \left(\left| \dfrac{S_n - \E S_n}{n} \right| > \varepsilon\right) \leqslant \dfrac{\D S_n}{n^2 \varepsilon^2}.$$ 
		Применяя лемму о дисперсии суммы, получаем 
		$$\dfrac{1}{n^2\varepsilon^2} \sum\limits_{i=1}^n \D \xi_i \rightarrow 0.$$
	\end{proof}
\end{theorem}
\begin{consequence}
